            ...
            <div class="text-center col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 class="panel-title">Make announcement</h1>
                    </div>
                    <form action="{{Route('announcement_made')}}" method="post">
                        {{csrf_field()}}
                        <div class="panel-body">
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon1">Title</span>
                                <input type="text" name="title" class="form-control" placeholder="Announcement title" aria-describedby="basic-addon1">
                            </div>
                            <br />
                            ...
                            <div class="input-group input-group-sm" role="group">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="date" name="announcement_date" placeholder="date of the activity">
                                        </td>
                                        <td>
                                            @if(!empty($branches))
                                                <fieldset>
