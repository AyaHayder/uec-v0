            ...
            <div class="text-center col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 class="panel-title">Create a new service</h1>
                    </div>
                    <form action="{{Route('make_service')}}" method="post">
                        {{csrf_field()}}
                        <div class="panel-body">
                            <div class="input-group">
                                <span class="input-group-addon" id="basic-addon1">Title</span>
                                <input type="text" name="title" class="form-control" placeholder="Service title" aria-describedby="basic-addon1">
                            </div>
                            <br />
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="icon" class="form-control" placeholder="insert image URL" aria-describedby="basic-addon1">
                                        </div>
                                        <br />
